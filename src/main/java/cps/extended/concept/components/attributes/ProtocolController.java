...
public class ProtocolController implements Serializable {
    ...
    @EJB
    private cps.extended.concept.components.attributes.ProtocolFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/attributes").getString("ProtocolCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/attributes").getString("ProtocolUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/attributes").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/attributes").getString("ProtocolDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/attributes").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Protocol getProtocol(java.lang.String id) {
    ...
    public static class ProtocolControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Protocol) {
                ...
                return getStringKey(o.getProtocol());
            } else {
