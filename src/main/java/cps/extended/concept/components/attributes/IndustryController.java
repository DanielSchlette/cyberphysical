...
public class IndustryController implements Serializable {
    ...
    @EJB
    private cps.extended.concept.components.attributes.IndustryFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/attributes").getString("IndustryCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/attributes").getString("IndustryUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/attributes").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/attributes").getString("IndustryDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/attributes").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Industry getIndustry(java.lang.String id) {
    ...
    public static class IndustryControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Industry) {
                ...
                return getStringKey(o.getIndustry());
            } else {
