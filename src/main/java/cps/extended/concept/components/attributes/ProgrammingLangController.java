...
public class ProgrammingLangController implements Serializable {
    ...
    @EJB
    private cps.extended.concept.components.attributes.ProgrammingLangFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/attributes").getString("ProgrammingLangCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/attributes").getString("ProgrammingLangUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/attributes").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/attributes").getString("ProgrammingLangDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/attributes").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public ProgrammingLang getProgrammingLang(java.lang.String id) {
